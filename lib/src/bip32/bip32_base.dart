...
import '../bs58/bs58check_base.dart' as bs58check;
...
final bitcoinNetworkType = NetworkType(wif: 0x80, bip32: Bip32Type(public: 0x0488b21e, private: 0x0488ade4));
...
class BIP32 {
  ...
  factory BIP32.fromBase58(String string, [NetworkType? nw]) {
    ...
    NetworkType network = nw ?? bitcoinNetworkType;
    ByteData bytes = buffer.buffer.asByteData();
