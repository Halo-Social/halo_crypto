...
Uint8List privateKeyBytesToCompressedPublic(Uint8List privateKey) {
  return privateKeyToCompressedPublic(bytesToUnsignedInt(privateKey));
}
...
Uint8List privateKeyToPublicWithFlag(BigInt privateKey) {
  final p = (params.G * privateKey)!;

  //skip the type flag, https://github.com/ethereumjs/ethereumjs-util/blob/master/index.js#L319
  return Uint8List.view(p.getEncoded(false).buffer);
}

Uint8List privateKeyToCompressedPublic(BigInt privateKey) {
  final p = (params.G * privateKey)!;
  return Uint8List.view(
     p.getEncoded(true).buffer);
